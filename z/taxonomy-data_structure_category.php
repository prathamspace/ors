...
<section class="container zoro-main">
    ...
    <!-- Breadcrumb -->
    <div class="zoro-breadcrumb text-ligx">
        <span class="text">Home</span>
        <h1 class="text-capitalize"><?php echo get_the_title(); ?></a></h1>
    </div>
    <!--  -->
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-3 col-lg-3 zoroWidget">
            ...
            <div class="codesidebar">
                <div id="mainSidebar">
                    <h2 class="widget-title"><i class="bi bi-code-slash"></i>Data Structure</h2>
                    <ul class="">
                        <?php
                        $args = array(
                            'taxonomy' => 'data_structure_category',
                            'orderby' => 'name',
                            'order'   => 'ASC'
                        );
